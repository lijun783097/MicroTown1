...
{
    MTTabBarItem *tabBarItem = [[MTTabBarItem alloc] initWithItemImageRatio:self.itemImageRatio];
...
- (void)buttonClick:(MTTabBarItem *)tabBarItem
{
...
- (void)layoutSubviews
{
    ...
    for (int index = 0; index < count; index++) {
        ...
        MTTabBarItem *tabBarItem = self.tabBarItems[index];
